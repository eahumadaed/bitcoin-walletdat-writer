...
# Unmodified except for the `test_framework.util` import below getting a
# local fallback (that helper is only used by this file's own unittest
# class, not by anything walletdat-forge calls). Upstream lives at
# https://github.com/bitcoin/bitcoin/blob/master/test/functional/test_framework/crypto/secp256k1.py
